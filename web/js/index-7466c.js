(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":1334,"designHeight":750,"scaleMode":"fixedauto","alignV":"middle","alignH":"center","screenMode":"horizontal","backgroundColor":"rgba(28, 90, 164, 1)"},"2D":{"FPS":30,"useRetinalCanvas":true,"defaultFont":"res/font/CookieRun Regular.otf","isAntialias":true,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFontSize":20},"3D":{"lightClusterCount":{"x":12,"y":12,"z":12},"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":16,"maxMorphTargetCount":32,"useBVHCull":false,"BVH_max_SpatialCount":7,"BVH_limit_size":32,"BVH_Min_Build_nums":10},"physics2D":{"gravity":{"y":500,"x":0},"drawAABB":true,"allowSleeping":true,"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawCenterOfMass":false},"splash":{"fit":"center","enabled":true,"duration":1},"physics3D":{"maxSubSteps":1,"fixedTimeStep":0.016666666666666666,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"Loading.ls","pkgs":[{"path":"","hash":"6b6fb"}]}`);
