"use strict";(()=>{var d_=Object.create;var El=Object.defineProperty;var iy=Object.getOwnPropertyDescriptor;var h_=Object.getOwnPropertyNames;var f_=Object.getPrototypeOf,b_=Object.prototype.hasOwnProperty;var ae=(a,t)=>()=>(a&&(t=a(a=0)),t);var y_=(a,t)=>()=>(t||a((t={exports:{}}).exports,t),t.exports),ay=(a,t)=>{for(var e in t)El(a,e,{get:t[e],enumerable:!0})},g_=(a,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of h_(t))!b_.call(a,n)&&n!==e&&El(a,n,{get:()=>t[n],enumerable:!(i=iy(t,n))||i.enumerable});return a};var v_=(a,t,e)=>(e=a!=null?d_(f_(a)):{},g_(t||!a||!a.__esModule?El(e,"default",{value:a,enumerable:!0}):e,a));var m=(a,t,e,i)=>{for(var n=i>1?void 0:i?iy(t,e):t,r=a.length-1,o;r>=0;r--)(o=a[r])&&(n=(i?o(t,e,n):o(n))||n);return i&&n&&El(t,e,n),n};function ry(a,t){return a.exec(t)?.groups}var oy=ae(()=>{"use strict"});function Bl(a){let t=a.type;if(sy.test(a.type)&&"components"in a){t="(";let e=a.components.length;for(let n=0;n<e;n++){let r=a.components[n];t+=Bl(r),n<e-1&&(t+=", ")}let i=ry(sy,a.type);return t+=`)${i?.array??""}`,Bl({...a,type:t})}return"indexed"in a&&a.indexed&&(t=`${t} indexed`),a.name?`${t} ${a.name}`:t}var sy,ly=ae(()=>{"use strict";oy();sy=/^tuple(?<array>(\[(\d*)\])*)$/});function er(a){let t="",e=a.length;for(let i=0;i<e;i++){let n=a[i];t+=Bl(n),i!==e-1&&(t+=", ")}return t}var cy=ae(()=>{"use strict";ly()});function bf(a){return a.type==="function"?`function ${a.name}(${er(a.inputs)})${a.stateMutability&&a.stateMutability!=="nonpayable"?` ${a.stateMutability}`:""}${a.outputs.length?` returns (${er(a.outputs)})`:""}`:a.type==="event"?`event ${a.name}(${er(a.inputs)})`:a.type==="error"?`error ${a.name}(${er(a.inputs)})`:a.type==="constructor"?`constructor(${er(a.inputs)})${a.stateMutability==="payable"?" payable":""}`:a.type==="fallback"?"fallback()":"receive() external payable"}var uy=ae(()=>{"use strict";cy()});var py=ae(()=>{"use strict";uy()});function Ut(a,{includeName:t=!1}={}){if(a.type!=="function"&&a.type!=="event"&&a.type!=="error")throw new Io(a.type);return`${a.name}(${xo(a.inputs,{includeName:t})})`}function xo(a,{includeName:t=!1}={}){return a?a.map(e=>S_(e,{includeName:t})).join(t?", ":","):""}function S_(a,{includeName:t}){return a.type.startsWith("tuple")?`(${xo(a.components,{includeName:t})})${a.type.slice(5)}`:a.type+(t&&a.name?` ${a.name}`:"")}var hn=ae(()=>{"use strict";Lt()});function nt(a,{strict:t=!0}={}){return!a||typeof a!="string"?!1:t?/^0x[0-9a-fA-F]*$/.test(a):a.startsWith("0x")}var Ei=ae(()=>{"use strict"});function Ze(a){return nt(a,{strict:!1})?Math.ceil((a.length-2)/2):a.length}var Ba=ae(()=>{"use strict";Ei()});var my,dy=ae(()=>{"use strict";my="2.9.3"});var hy,fn,fy,Eo=ae(()=>{"use strict";dy();hy=a=>a,fn=a=>a,fy=()=>`viem@${my}`});function by(a,t){return t?.(a)?a:a&&typeof a=="object"&&"cause"in a?by(a.cause,t):t?null:a}var B,Ge=ae(()=>{"use strict";Eo();B=class a extends Error{constructor(t,e={}){super(),Object.defineProperty(this,"details",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"docsPath",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"metaMessages",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"shortMessage",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"ViemError"}),Object.defineProperty(this,"version",{enumerable:!0,configurable:!0,writable:!0,value:fy()});let i=e.cause instanceof a?e.cause.details:e.cause?.message?e.cause.message:e.details,n=e.cause instanceof a&&e.cause.docsPath||e.docsPath;this.message=[t||"An error occurred.","",...e.metaMessages?[...e.metaMessages,""]:[],...n?[`Docs: https://viem.sh${n}${e.docsSlug?`#${e.docsSlug}`:""}`]:[],...i?[`Details: ${i}`]:[],`Version: ${this.version}`].join(`
`),e.cause&&(this.cause=e.cause),this.details=i,this.docsPath=n,this.metaMessages=e.metaMessages,this.shortMessage=t}walk(t){return by(this,t)}}});var So,tr,bn,Si,To,Co,ko,yn,Ao,gn,ir,ia,Do,Rl,Mo,di,Ti,Po,Bo,Ro,Io,Lt=ae(()=>{"use strict";hn();Ba();Ge();So=class extends B{constructor({docsPath:t}){super(["A constructor was not found on the ABI.","Make sure you are using the correct ABI and that the constructor exists on it."].join(`
`),{docsPath:t}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiConstructorNotFoundError"})}},tr=class extends B{constructor({docsPath:t}){super(["Constructor arguments were provided (`args`), but a constructor parameters (`inputs`) were not found on the ABI.","Make sure you are using the correct ABI, and that the `inputs` attribute on the constructor exists."].join(`
`),{docsPath:t}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiConstructorParamsNotFoundError"})}},bn=class extends B{constructor({data:t,params:e,size:i}){super([`Data size of ${i} bytes is too small for given parameters.`].join(`
...
`)),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiEncodingLengthMismatchError"})}},yn=class extends B{constructor(t,{docsPath:e}){super([`Encoded error signature "${t}" not found on ABI.`,"Make sure you are using the correct ABI and that the error exists on it.",`You can look up the decoded signature here: https://openchain.xyz/signatures?query=${t}.`].join(`
`),{docsPath:e}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiErrorSignatureNotFoundError"}),Object.defineProperty(this,"signature",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.signature=t}},Ao=class extends B{constructor({docsPath:t}){super("Cannot extract event signature from empty topics.",{docsPath:t}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiEventSignatureEmptyTopicsError"})}},gn=class extends B{constructor(t,{docsPath:e}){super([`Encoded event signature "${t}" not found on ABI.`,"Make sure you are using the correct ABI and that the event exists on it.",`You can look up the signature here: https://openchain.xyz/signatures?query=${t}.`].join(`
`),{docsPath:e}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AbiEventSignatureNotFoundError"})}},ir=class extends B{constructor(t,{docsPath:e}={}){super([`Event ${t?`"${t}" `:""}not found on ABI.`,"Make sure you are using the correct ABI and that the event exists on it."].join(`
...
`),{metaMessages:[`Params: (${xo(i,{includeName:!0})})`,`Data:   ${e} (${n} bytes)`]}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"DecodeLogDataMismatch"}),Object.defineProperty(this,"abiItem",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"data",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"params",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"size",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.abiItem=t,this.data=e,this.params=i,this.size=n}},Ti=class extends B{constructor({abiItem:t,param:e}){super([`Expected a topic for indexed event parameter${e.name?` "${e.name}"`:""} on event "${Ut(t,{includeName:!0})}".`].join(`
