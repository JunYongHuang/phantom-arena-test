 ...
 * @LastEditors: hjy
 * @LastEditTime: 2024-07-22 19:08:17
 */


var game_version = "V_0724_01";	
...
function initLiveChat(){
	if(!isInitLiveChat){
		...
		window.__lc.license = 18316131;//正式版
		...
		window.LCCallback = function() {
            window.LC_API.on_chat_started = function(chat_id) {
                console.log("会话 ID: " + chat_id);
            };
        };
	}
